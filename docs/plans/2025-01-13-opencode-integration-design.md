...
Add OpenCode session detection alongside Claude Code, showing both in a unified "Agent Sessions" view. Sessions from each agent will be visually distinguished by a small icon/badge on each card.
